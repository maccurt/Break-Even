...
export class CreditCardScenario1 implements ICreditCardBase {
    ...
    miniumPayResult = {
        ...
        interest: '11,979.30',
        total: '21,979.30',
        interestSaved: '$7,291.24',
        interestSavedFormula: '$21,979.30 - $14,688.06',
        interestSavedPercent: 'You Will Save 60.87% In Interest.',
    ...
    extraPayResult = {
        ...
        principal: '10,000.00',
        interest: '3,878.30',
        interestSaved: '$8,101.00',
        interestSavedFormula: '$21,979.30 - $13,878.30',
    ...
    fixedPayResult = {
        ...
        principal: '10,000.00',
        interest: '1,579.48',
        interestSaved: '$10,399.82',
        interestSavedFormula: '$21,979.30 - $11,579.48',
